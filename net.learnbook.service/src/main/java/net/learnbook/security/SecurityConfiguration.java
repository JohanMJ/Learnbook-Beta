...
/*	@Override
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().authorizeRequests()
			...
			.antMatchers("/dev/course/required").permitAll()
			...
			.antMatchers("/dev/course/listgroup/{iCodUser}").permitAll()
			.antMatchers("/dev/user/listAllGroup/{iCodGru}").permitAll()
			.antMatchers("/dev/activity/listreview").permitAll()
			...
			.antMatchers("/dev/user/listAllCompanies").permitAll()
